// Brand logo SVGs — lucide-react no longer ships brand icons, so these keep the
// correct logos regardless of the installed lucide version. All accept a
// className (default size-4) and use currentColor so they inherit text color.
