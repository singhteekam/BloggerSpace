  ...
  return (
    <section className="newpage-section">
      <Container>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to BloggerSpace.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to BloggerSpace, accessible from{" "}
              <a
                href="https://bloggerspace.singhteekam.in/"
        ...
        <ul>
          <li>
            <p>By email: contact.singhteekam@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://bloggerspace.singhteekam.in/contactus"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://bloggerspace.singhteekam.in/contactus
              </a>
            </p>
          </li>
        </ul>
