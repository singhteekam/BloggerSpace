...
const TermsAndConditions = () => {
  return (
    <div className="mt-5">
      ...
      <p>Welcome to BloggerSpace!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of BloggerSpace's Website, located at
        https://bloggerspace.singhteekam.in/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use BloggerSpace if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing BloggerSpace, you agreed to
        use cookies in agreement with the BloggerSpace's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, BloggerSpace and/or its licensors own the
        intellectual property rights for all material on BloggerSpace. All
        intellectual property rights are reserved. You may access this from
        BloggerSpace for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from BloggerSpace</li>
        <li>Sell, rent or sub-license material from BloggerSpace</li>
        <li>Reproduce, duplicate or copy material from BloggerSpace</li>
        <li>Redistribute content from BloggerSpace</li>
      </ul>
      ...
      <p>
        ...
        BloggerSpace does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of BloggerSpace,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, BloggerSpace shall not be
      ...
      <p>
        BloggerSpace reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant BloggerSpace a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of BloggerSpace; and (d) the link
      ...
      <p>
        ...
        e-mail to BloggerSpace. Please include your name, your organization
      ...
      <p>
        No use of BloggerSpace's logo or other artwork will be allowed for
